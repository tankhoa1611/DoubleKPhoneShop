...
namespace DoubleKPhoneShop.Controllers
{
    public class OrderDetailController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderDetailId,OrderId,Quantity")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderDetailId,OrderId,Quantity")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
