...
namespace DoubleKPhoneShop.Controllers
{
    public class OrderController : Controller
    {
...

        {
            ...
            Order order = db.Orders.Where(o => o.OrderId == id).Include(a=>a.OrderDetails.Select(b=>b.Product)).FirstOrDefault();
            if (order == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "OrderId,OrderDate,UserId")] Order order)
        {
