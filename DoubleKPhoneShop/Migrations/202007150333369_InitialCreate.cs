                ...
                c => new
                    {
                        ...
                        OperatingSystem = c.String(maxLength: 50),
                        Cameras = c.String(maxLength: 50),
                        CPU = c.String(maxLength: 50),
                        RAM = c.String(maxLength: 50),
                        ROM = c.String(maxLength: 50),
                        Batery = c.String(maxLength: 50),
                    })
                ...
                c => new
                    {
                        ...
                        SumPay = c.Double(nullable: false),
                    })
                ...
                c => new
                    {
                        ...
                        Status = c.String(),
                        TotalPay = c.Double(nullable: false),
                    })
